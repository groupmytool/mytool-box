...
public class SettingsButton extends Button {
  ...
  public SettingsButton(Image iconImage, StringProperty settingsTextProperty, EventHandler<MouseEvent> eventHandler) {
    super();
    this.setPrefWidth(Double.MAX_VALUE);
    this.setPrefHeight(30);
    this.setOnMouseClicked(eventHandler);
    this.textProperty().bind(settingsTextProperty);
